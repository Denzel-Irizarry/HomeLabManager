(() => {
    // This script is intentionally page-specific. App-wide theme behavior now lives in
    // App.razor, while this file only handles the legacy DOM wiring for the register-image
    // page when that page is present in the rendered HTML.
    ...
    function initRegisterImagePage() {
        ...
        // Guard against Blazor enhanced navigation re-running this script. Once the page
        // is initialized we do not want duplicate event listeners on the same controls.
        ...
        // If the expected DOM is not present, exit quietly. This lets the same script load
        // globally without breaking other pages.
    ...
    // Re-initialize after enhanced navigation or bfcache restore because this page can be
    // revisited without a full browser reload.
